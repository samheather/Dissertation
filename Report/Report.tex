...
In practise though, the output of a hashing algorithm tends not to be unique to the input, because a hash from an algorithm is of a pre-defined length.  This is demonstrated by the commonly used hashing algorithm, MD5.  MD5 produces as output of 128 bits in size, meaning there are 2128 possible outputs.  Although this number is very large, 
