...
Access to knowledge is, in the opinion of the author, a critical part of modern life.  It's also a Human Right, under Article 27 of the Universal Declaration of Human Rights~\cite{community1948universal}.  We use tools to access knowledge hundreds of times each day, often unaware that we are doing so.  Despite this, hundreds of millions of individuals live without this facility.  This project aims to \marginnote{does it really investigate the (technical)(?) problem?}investigate the (technical)(?) problem behind this and to create a technology to give more people access to knowledge, and thus their human rights.
...
The logical database requirements are listen in Table \ref{table:logicalDatabaseDesignListing} and represented graphically in \ref{table:logicalDatabaseDesignDiagram}.
...
\label{table:logicalDatabaseDesignDiagram}
\end{figure}
