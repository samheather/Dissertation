...
% TODO - component view. and make sure described the diagram somewhere.
...
% TODO delete below ref discussion
...
The application was evaluated through an experimental evaluation where participants were asked to use the application and then complete a questionnaire. The questionnaire specifically asked questions that measured how useful the application was its usability. The application was also compared to the user requirements, functional system requirements and non-functional system requirements.

The overall implementation of the system is viewed as been a success, with the application fulfilling all of its functional system requirements and the majority of its user requirements and non-functional system requirements. Participants in the experimental evaluation also rated the application positively.

One of the more complex parts of this project was extracting high quality information from the data sources used. This affected the answer location system, sometimes resulting in the application been unable to find a simple answer or providing answers to questions which request a measurement of something without any units. 

There was an awareness of ethical issues throughout this project, with a specific focus on protecting the privacy of users. This was well researched in the early stages of the project.

There is substantial room for future work to both expand this project and fix some of the limitations, including improvements to the natural language processing and machine learning systems. However the application developed did meet its goals and despite its limitations a tool was produced that is capable of providing useful information to a user.
