...
When \texttt{population} is requested, the value for \texttt{areaUrban} is returned with semantic similarity of 0.30488 (5 significant figures) instead of \texttt{height\_max}, which also has a semantic similarity of 0.30488.
...
In this section the results from the experiment are presented and analysed. The key piece of research been investigated is whether the application learns effectively, although results for general usefulness and usability are also presented. The raw data that has been analysed below is included in Appendix XYZ.
% TODO ask lilian what to do with raw data? and above line: ^
