...
Another assumption made in this project is that the users who may use this service have access to SMS facilities. Although SMS coverage does cover a majority of the world there are remote areas where it does not, and in these areas the application would be inaccessible.
