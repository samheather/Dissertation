...
It necessary to be able to identify the geographical entity in the query. This will be done using a Named Entity Extraction tool (of which there many tools available online, including Cortical\footnote{http://www.cortical.io/demos/keyword-extraction/}, Dandelion\footnote{https://dandelion.eu/products/datatxt/nex/demo}). These tools extract keywords from a text and in some cases are capable of categorising keywords according to an ontology. For example, Dandelion links entities to the DBPedia Ontology \cite{dandelionNex}.
