...
% TODO - write the boundary at which I will say I succeeded (if I consistently score about netural)
% TODO - write about Likert model for setting questionnaire scale.
...
% TODO - write Creating HTTP Server.
...
\begin{itemize}
  ...
  \item The Twilio service was used to facilitate the SMS interface to the server application.
  \item The Cortical and Dandelion API's were used for semantic analysis of text.
\end{itemize}
...
\begin{itemize}
    ...
    \item Twilio - Twilio library used for receiving and sending SMS.
...
In this section, a description of how the natural language processing module was implemented.
% TODO - write this
