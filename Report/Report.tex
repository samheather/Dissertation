...
This project will use semantic comparison of text to locate information in remote data sources, so it is important to have an understanding of the different ways of semantically comparing text.
