...
\begin{enumerate}
  ...
  \item Common libraries that I will use for crating HTTP servers \marginnote{terminology}, database queries and sending SMS tend to be written primarily on the Linux platform.
...
\begin{itemize}
  \item Male, Aged 27
  \item Lives in Zurich (Switzerland) and goes for regular weekend hiking trips in the Alps, where mobile signal is naturally patchy.
